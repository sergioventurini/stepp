...
{viewerjumpto "estat" "stepp postestimation##syntax_estat"}{...}
{viewerjumpto "estat options" "stepp postestimation##options_estat"}{...}
{viewerjumpto "Examples" "stepp postestimation##examples"}{...}
{viewerjumpto "Authors" "stepp postestimation##authors"}{...}
{viewerjumpto "References" "stepp postestimation##references"}{...}
{title:Title}

{p 4 18 2}
{hi:stepp postestimation} {hline 2} Postestimation tools for {helpb stepp}
...
{title:Stored results for estat ...}
